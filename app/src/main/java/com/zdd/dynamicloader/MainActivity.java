...
import com.zdd.pluginimpl.IBean;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_1.setOnClickListener(new View.OnClickListener() {//普通调用  反射的方式
            ...
            public void onClick(View arg0) {
                ...
                try {
                    mLoadClassBean = classLoader.loadClass("com.zdd.pluginsdks.bean.Bean");
        ...
        btn_3.setOnClickListener(new View.OnClickListener() {//带回调函数的调用
            ...
            public void onClick(View arg0) {
                ...
                try {
                    mLoadClassDynamic = classLoader.loadClass("com.zdd.pluginsdks.imp.Dynamic");
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    dynamic.startPluginActivity(MainActivity.this,
                            classLoader.loadClass("com.zdd.dynamicloader.MainActivity"));
                } catch (Exception e) {
                    Log.e("DEMO", "msg:" + e.getMessage());
                }
            }
